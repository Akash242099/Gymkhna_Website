...
(function(addon) {
    ...
    moment = (function (undefined) {
        ...
        ************************************/
        ...
        // TODO: remove 'username' arg after deprecation is removed
        ...
        ************************************/
        ...
        function addTimeToArrayFromToken(token, input, config) {
            ...
            case 'MMMM' :
                ...
                // if we didn't find a month username, mark the date as invalid.
                if (a != null) {
            ...
            case 'dddd':
                ...
                // if we didn't get a weekday username, mark the date as invalid
                if (a != null) {
                    config._w = config._w || {};
                    config._w['d'] = a;
                } else {
